...
public class ScoreTab extends JPanel {
  ...
  "Course 5", "Score 5", "GPA"
    ...
    private JPanel createBottomButtonPanel() {
        ...
        saveBtn = new StyledButton("Save", new Color(73, 118, 159), new Color(53, 93, 134));
        saveBtn.setForeground(Color.WHITE);
        clearBtn = new StyledButton("Clear", new Color(73, 118, 159), new Color(53, 93, 134));
        clearBtn.setForeground(Color.WHITE);
        updateBtn = new StyledButton("Update", new Color(73, 118, 159), new Color(53, 93, 134));
